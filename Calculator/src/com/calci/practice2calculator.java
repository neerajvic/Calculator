...
public class practice2calculator {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					practice2calculator window = new practice2calculator();
	...
	private void initialize() {
		...
		bhagakar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textField.setText(textField.getText() + display.getText() + bhagakar.getText());
		...
		into.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String ops = textField.getText() +display.getText() + into.getText();
		...
		minus.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String ops = textField.getText() + display.getText() + minus.getText();
				textField.setText(ops);
				display.setText(null);
		...
		plus.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String ops = textField.getText() + display.getText() + plus.getText();
				textField.setText(ops);
				display.setText(null);	
		...
		takkke.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String ops = textField.getText() + display.getText() + takkke.getText();
				textField.setText(ops);
				display.setText(null);	
		...
		equalto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textField.setText(String.valueOf(opr));
